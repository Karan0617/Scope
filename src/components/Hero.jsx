            ...
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <img
                  ...
                  src="https://i.postimg.cc/GmVNZ6QF/logo.png"
                  alt=""
                />
              </a>
              <button
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#"
                  className="rounded-full bg-indigo-700 px-3.5 py-2.5 text-md font-semibold text-white shadow-lg hover:bg-purple-500 focus-visible: focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:"
                >
                  Get started
                </a>
